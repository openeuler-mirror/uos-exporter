...
var (
	...
	DefaultConfig = Config{
		Logging: logger.Config{
			Level:   "debug",
			LogPath: "/var/log/uos-exporter/prometheus-paperless-exporter.log",
			MaxSize: "10MB",
...
func init() {
	...
	//Configfile = kingpin.Flag("config", "Configuration file").
		//Short('c').
		//Default("/etc/uos-exporter/prometheus-paperless-exporter.yaml").
		//String()
        ConfigfileTmp := "/etc/uos-exporter/prometheus-paperless-exporter.yaml"
        Configfile = &ConfigfileTmp
}
