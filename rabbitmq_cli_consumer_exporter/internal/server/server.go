...
import (
	...
	"rabbitmq_cli_consumer_exporter/config"
	"rabbitmq_cli_consumer_exporter/internal/exporter"
	_ "rabbitmq_cli_consumer_exporter/internal/metrics"
	"rabbitmq_cli_consumer_exporter/pkg/logger"
	"rabbitmq_cli_consumer_exporter/pkg/ratelimit"
