...
func TestStringerLockData(t *testing.T) {
	oneLock := GetLockData(LockDataOneLine)[0]
	...
	oneLock = GetLockData(LockDataCluster)[0]
	lockStr = oneLock.String()
...
func TestStringerShareData(t *testing.T) {
	oneShare := GetShareData(ShareDataOneLine)[0]
	...
	oneShare = GetShareData(ShareDataCluster)[0]
...
func TestStringerProcessData(t *testing.T) {
	oneProcess := GetProcessData(ProcessDataOneLine)[0]
	...
	oneProcess = GetProcessData(ProcessDataCluster)[0]
...
func TestGetLockDataOneLine(t *testing.T) {
	oneEntry := GetLockData(LockDataOneLine)
...
func TestGetLockData4Line(t *testing.T) {
	entryList := GetLockData(LockData4Lines)
...
func TestGetLockDataFileNameWithSpaces(t *testing.T) {
	entryList := GetLockData(LockData1LineWithSpaces)
...
func TestGetLockDataInvalidResponse(t *testing.T) {
	entryList := GetLockData(LockDataInvadlidResponse)
...
func TestGetLockDataCluster(t *testing.T) {
	entryList := GetLockData(LockDataCluster)
...
func TestGetLockDataWrongInput(t *testing.T) {
	entryList := GetLockData(ProcessData4Lines)
...
func TestGetLockData0Input(t *testing.T) {
	entryList := GetLockData(LockData0Line)
...
func TestGetLockDataNoData(t *testing.T) {
	entryList := GetLockData(LockDataNoData)
...
func TestGetLockDataNoDataV4_17_7(t *testing.T) {
	entryList := GetLockData(LockDataNoDataV4_17_7)
...
func TestGetLockDataEmpty(t *testing.T) {
	entryList := GetLockData(LockDataEmpty)
...
func TestGetShareDataDifferentTimeStampLines(t *testing.T) {
	entryList := GetShareData(ShareDataDifferentTimeStampLines)
...
func TestGetShareDataOneLine(t *testing.T) {
	oneEntry := GetShareData(ShareDataOneLine)
	fmt.Print(oneEntry)
	if len(oneEntry) != 1 {
		t.Errorf("Expected 1 entry, got %d", len(oneEntry))
	}
...
func TestGetShareData4Line(t *testing.T) {
	entries := GetShareData(ShareData4Lines)
...
func TestGetShareDataInvlaideResponse(t *testing.T) {
	entries := GetShareData(ShareData4LinesInvalide)
...
func TestGetShareDataNamesWithSpaces(t *testing.T) {
	entries := GetShareData(ShareData4LinesWithSpacesInName)
...
func TestGetShareDataCluster(t *testing.T) {
	entries := GetShareData(ShareDataCluster)
...
func TestGetShareDataWrongData(t *testing.T) {
	entries := GetShareData(LockData4Lines)
...
func TestGetShareData0Input(t *testing.T) {
	entryList := GetShareData(ShareData0Line)
...
func TestGetProcessDataOneLine(t *testing.T) {
	oneProcess := GetProcessData(ProcessDataOneLine)
...
func TestGetProcessData4Line(t *testing.T) {
	enties := GetProcessData(ProcessData4Lines)
...
func TestGetProcessDataCluster(t *testing.T) {
	enties := GetProcessData(ProcessDataCluster)
...
func TestGetProcessDataWrongData(t *testing.T) {
	enties := GetProcessData(LockData4Lines)
...
func TestGetProcessData0Input(t *testing.T) {
	entryList := GetProcessData(ProcessData0Lines)
...
func TestGetPsDataEmptyInput(t *testing.T) {
	jsonData := TestPsResponseEmpty()
	entryList := GetPsData(string(jsonData))
