...
func (c *crmMonCollector) Describe(ch chan<- *prometheus.Desc) {
	ch <- c.crmMonInfo
	ch <- c.crmMonLastUpdate
	ch <- c.crmMonLastChange
	ch <- c.crmMonDCPresent
	ch <- c.crmMonDCQuorum
	ch <- c.crmMonNodesConfigured
	ch <- c.crmMonResourcesConfigured
	ch <- c.crmMonResourcesDisabled
	ch <- c.crmMonResourcesBlocked
	ch <- c.crmMonStonith
	ch <- c.crmMonSymmetricCluster
	ch <- c.crmMonMaintenanceMode
	ch <- c.crmMonNodeID
	ch <- c.crmMonNodeOnline
	ch <- c.crmMonNodeStandby
	ch <- c.crmMonNodeStandbyOnFail
	ch <- c.crmMonNodeMaintenance
	ch <- c.crmMonNodePending
	ch <- c.crmMonNodeUnclean
	ch <- c.crmMonNodeShutdown
	ch <- c.crmMonNodeExpectedUp
	ch <- c.crmMonNodeIsDC
	ch <- c.crmMonNodeResourcesRunning
	ch <- c.crmMonNodeAttribute
	ch <- c.crmMonResourceActive
	ch <- c.crmMonResourceOrphaned
	ch <- c.crmMonResourceBlocked
	ch <- c.crmMonResourceManaged
	ch <- c.crmMonResourceFailed
	ch <- c.crmMonResourceFailureIgnored
	ch <- c.crmMonResourcesGroup
	ch <- c.crmMonResourceGroupActive
	ch <- c.crmMonResourceGroupOrphaned
	ch <- c.crmMonResourceGroupBlocked
	ch <- c.crmMonResourceGroupManaged
	ch <- c.crmMonResourceGroupFailed
	ch <- c.crmMonResourceGroupFailureIgnored
	ch <- c.crmMonResourceCloneMultistate
	ch <- c.crmMonResourceClonePromoted
	ch <- c.crmMonResourceCloneActive
	ch <- c.crmMonResourceCloneOrphaned
	ch <- c.crmMonResourceCloneBlocked
	ch <- c.crmMonResourceCloneManaged
	ch <- c.crmMonResourceCloneFailed
	ch <- c.crmMonResourceCloneFailureIgnored
	ch <- c.crmMonResourceCloneNumActive
	ch <- c.crmMonResourceCloneNumPromoted
	ch <- c.crmMonFailuresCount
	ch <- c.crmMonFailureDescription
	ch <- c.crmMonBansCount
	ch <- c.crmMonBanDescription
