...
func TestNewRunitCollector(t *testing.T) {
	// Test case 1: Basic collector creation
	collector := NewRunitCollector()
	if collector == nil {
		t.Fatal("NewRunitCollector() returned nil")
	}
...
func TestRunitCollectorCollect(t *testing.T) {
	...
	case <-done:
		...
		t.Logf("Collected %d runit metrics", metricCount)
...
func TestRunitCollectorMetricsRegistration(t *testing.T) {
...
func TestRunitCollectorConcurrency(t *testing.T) {
	collector := NewRunitCollector()
...
func TestRunitCollectorErrorHandling(t *testing.T) {
	collector := NewRunitCollector()
