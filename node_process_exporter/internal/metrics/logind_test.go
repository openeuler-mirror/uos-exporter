...
func TestNewLogindCollector(t *testing.T) {
	// Test case 1: Basic collector creation
	collector := NewLogindCollector()
	if collector == nil {
		t.Fatal("NewLogindCollector() returned nil")
	}
...
func TestLogindCollectorCollect(t *testing.T) {
	...
	case <-done:
		...
		t.Logf("Collected %d logind metrics", metricCount)
...
func TestLogindCollectorMetricsRegistration(t *testing.T) {
...
func TestLogindCollectorConcurrency(t *testing.T) {
	collector := NewLogindCollector()
...
func TestLogindCollectorErrorHandling(t *testing.T) {
	collector := NewLogindCollector()
