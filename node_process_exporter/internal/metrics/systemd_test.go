...
func TestNewSystemdCollector(t *testing.T) {
...
func TestSystemdCollectorCollect(t *testing.T) {
	...
	case <-done:
		...
		t.Logf("Collected %d systemd metrics", metricCount)
...
func TestSystemdCollectorMetricsRegistration(t *testing.T) {
...
func TestSystemdCollectorConcurrency(t *testing.T) {
	collector := NewSystemdCollector()
...
func TestSystemdCollectorErrorHandling(t *testing.T) {
	collector := NewSystemdCollector()
...
// Part 2 commit for node_process_exporter/internal/metrics/systemd_test.go
