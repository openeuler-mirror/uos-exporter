...
import (
	...
	"opengauss_exporter/config"
	"opengauss_exporter/internal/exporter"
	_ "opengauss_exporter/internal/metrics"
	"opengauss_exporter/pkg/logger"
	"opengauss_exporter/pkg/ratelimit"
...
// Part 2 commit for opengauss_exporter/internal/server/server.go
