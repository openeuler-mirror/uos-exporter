...
import (
	...
	"prometheus_varnish_exporter/config"
	"prometheus_varnish_exporter/internal/exporter"
	_ "prometheus_varnish_exporter/internal/metrics"
	"prometheus_varnish_exporter/pkg/logger"
	"prometheus_varnish_exporter/pkg/ratelimit"
